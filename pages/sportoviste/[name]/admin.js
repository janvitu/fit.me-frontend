											...
											<div className="px-4 py-5 bg-white space-y-6 sm:p-6">
												...
												<div>
													...
													<div className="mt-1">
														<textarea
															onChange={formik.handleChange}
															value={formik.values["openHoursFrom"]}
															id="openHoursFrom"
															name="openHoursFrom"
															rows={2}
															className="py-1 px-3 shadow-sm focus:ring-main-500 focus:border-main-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md"
												...
												<div>
													...
													<div className="mt-1">
														<textarea
															onChange={formik.handleChange}
															value={formik.values["openHoursTo"]}
															id="openHoursTo"
															name="openHoursTo"
															rows={2}
															className="py-1 px-3 shadow-sm focus:ring-main-500 focus:border-main-500 mt-1 block w-full sm:text-sm border border-gray-300 rounded-md"
													...
													<div className="flex flex-col md:flex-row sm:mt-2">
														<div className="grid grid-cols-3 gap-6 mt-1 ">
															<div className="col-span-3">
																<div className="mt-1 flex rounded-md shadow-sm">
																	<span className="w-16 py-1 px-3 inline-flex items-center rounded-l-md border border-r-1 border-gray-300 bg-gray-50 text-gray-500 text-sm">
																		Tel.:
																	</span>
																	<input
																		onChange={formik.handleChange}
