...
import { OverlappingCard, CTA, StatsWithImg } from "@components/molecules";
...
export default function Home() {
	...
	return (
		<StaticSite>
			...
			<StatsWithImg 
				imgSrc = "https://images.unsplash.com/photo-1522071820081-009f0129c71c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=2850&q=80"
				imgAlt = "Support Team"
				svgVector = "M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"
				headerText = "Spolupracují s námi sportoviště z 10 měst"
				descriptionText = 'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Dolore nihil ea rerum ipsa.
				...
				firstSubtitle = "Sportovišť"
				secondSubtitle = "Spokojených uživatelů"
				thirdSubtitle = "Spálených kalorií"
				firstIndicator = "200 +"
				secondIndicator = "30 000 +"
				thirdIndicator = "100 000 +"
			/>
